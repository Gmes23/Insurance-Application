  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(DataTableTemplatingDemo, [{
    ...
    value: function handleEdit(rowData, e) {
      ...
      fetch('http://localhost:4000/user/' + userId, {
        ...
        return response.json();
      }); // .then(data => this.setState({ users: data }));s
    }
  }, {
    key: "colorTemplate",
    ...
    value: function actionTemplate(rowData, column) {
      ...
      return __jsx("div", {
        ...
        onClick: function onClick(e) {
          return _this2.handleDelete(rowData, e);
        },
        __self: this,
        __source: {
          fileName: _jsxFileName,
        ...
        onClick: function onClick(e) {
          return _this2.handleEdit(rowData, e);
        },
        __self: this,
        __source: {
          fileName: _jsxFileName,
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      console.log(prevStateusers, 'prevState'); // if (prevState.users !== this.state.users) {
      // fetch('http://localhost:4000/user', {
      //     method: 'GET',
...
//# sourceMappingURL=dashboard.js.2cf3e678a29d204d2958.hot-update.js.map